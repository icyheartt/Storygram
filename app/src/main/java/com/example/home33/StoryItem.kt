...
open class StoryItem(var content: String? = null, var date: String? = null, var imageurl: String? = null, var tag: ArrayList<String>? = null) {
    ...
    fun to_ArrayList(): ArrayList<StoryItem> {
        val storyItemList = ArrayList<StoryItem>()
        val storyItem1 = StoryItem(content, date, imageurl, arrayListOf("태그1", "태그2"))
        storyItemList.add(storyItem1)
